...
class TestHATlmWeatherService:
    ...
    def setup(self):
        ...
        self.conf = Mock()
        conf_values = {
           'task_running_timeout': 4,
           'check_task_interval': 10,
           'weather_cache_timeout': 10,
           'weather_api_rate': 1,
        }
    ...
    def test_from_slow_cache(self):
        ...
        self.fast_cache.set_value.assert_called_with('TLL', '-5.5', expiretime=10)

    def test_from_external(self):
        self.parser.get_weather_location.return_value = 'BKK'
        self.fast_cache.get.return_value = None
        self.slow_cache.get.return_value = None
        self.tools.increase_counter.return_value = 1, 1
        ...
        self.tools.decrease_counter.assert_called()
        self.fast_cache.set_value.assert_called_with('BKK', '+28.1', expiretime=10)
        self.slow_cache.set_value.assert_called_with('BKK', '+28.1', expiretime=10)
